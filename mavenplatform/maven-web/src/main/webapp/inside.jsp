	...
	<div class="box-wrap">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<ul class="nav text-center">
								<li><a href="index.jsp"><span>Work</span>
								</a>
								</li>
								<li class="active"><a href="inside.jsp">About</a>
								</li>
				...
				<div class="row">
					<div
						...
						<div class="intro animate-box">
							<h1>About Us</h1>
							<h2>We are web agency based in London &amp; we love
								functional &amp; meaningful design.</h2>
						</div>
					</div>
				</div>
				<div>
		...
		<div class="container">
			<div class="col-md-8 col-md-offset-2 animate-box">
				...
				<p>She packed her seven versalia, put her initial into the belt
					and made herself on the way. When she reached the first hills of
					the Italic Mountains, she had a last view back on the skyline of
					her hometown Bookmarksgrove, the headline of Alphabet Village and
					...
					<div class="post-entry">
						<div class="col-md-6">
							<div class="post animate-box">
								<a href="#"><img src="images/work-2.jpg" alt="Product">
								</a>
								<div>
									<h3>
										<a href="#">Camera Lenses</a>
									</h3>
									<p>Far far away, behind the word, far from the countries
										Vokalia</p>
						...
						<div class="col-md-6">
							<div class="post animate-box">
								<a href="#"><img src="images/work-1.jpg" alt="Product">
								</a>
								<div>
									<h3>
										<a href="#">Camera Lenses</a>
